//! Unit tests for blocking client functionality using httpmock.
//!
...
#[cfg(feature = "blocking")]
#[test]
fn blocking_get_variables_parses_scientific_notation() {
    ...
    let fox = Fox::new_with_base_url_and_clock("TEST_API_KEY", "TEST_SN", 5, &server.base_url(), fixed_now).unwrap();
    let res = fox.get_variables(vec![FoxVariables::SoC, FoxVariables::PvPower]).unwrap();
...
#[cfg(feature = "blocking")]
#[test]
fn blocking_get_variables_history() {
    ...
    let res = fox.get_variables_history(start, end, vec![FoxVariables::PvPower]).unwrap();
...
#[cfg(feature = "blocking")]
#[test]
fn blocking_set_battery_charging_time_schedule() {
    ...
    let _ = fox.set_battery_charging_time_schedule(true, start, end).unwrap();
}
...
#[cfg(feature = "blocking")]
#[test]
fn blocking_set_battery_charging_time_schedule_end_before_start() {
    use chrono::{TimeZone, Utc, Local};
    use crate::Fox;
    ...
    let err = fox.set_battery_charging_time_schedule(true, start, end)
        .err()
...
#[cfg(feature = "blocking")]
#[test]
fn blocking_get_error_code_information() {
    use crate::Fox;
    ...
    let fox = Fox::new_with_base_url_and_clock("TEST_API_KEY", "TEST_SN", 5, &server.base_url(), fixed_now).unwrap();
    let res = fox.get_error_code_information().unwrap();
...
#[cfg(feature = "blocking")]
#[test]
fn blocking_set_scheduler_time_segments() {
    use crate::Fox;
    use crate::FoxWorkModes;
...
#[cfg(feature = "blocking")]
#[test]
fn blocking_get_main_switch_status() {
    use crate::Fox;
    ...
    let fox = Fox::new_with_base_url_and_clock("TEST_API_KEY", "TEST_SN", 5, &server.base_url(), fixed_now).unwrap();
    let res = fox.get_main_switch_status().unwrap();
...
#[cfg(feature = "blocking")]
#[test]
fn blocking_set_main_switch_status() {
    use crate::Fox;
    ...
    let _ = fox.set_main_switch_status(true).unwrap();
}
