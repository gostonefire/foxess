...
use thiserror::Error;
use crate::models::{DeviceHistory, DeviceHistoryData, DeviceHistoryResult, DeviceRealTime, DeviceRealTimeResult, RequestDeviceHistoryData, RequestDeviceRealTimeData};
...
mod tests {
    ...
    async fn it_works() {
        ...
        let r = fox.get_device_real_time_data().await.unwrap_or_else(|e| {
            panic!("Failed to get device real time data: {e}");
        });

        println!("{} {} {} {}", r.ld_power, r.pv_power, r.soc, r.soh);
